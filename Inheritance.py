...
user1 = Citizen_of_Ukraine("Bogdan", 1000, "developer")
user2 = Citizen_of_Ukraine("Max", 1200, "graphic designer")
user3 = Citizen_of_Ukraine("Taras", 2900, "product manager")
user4 = citizen_of_another_state("Nestor", 1800, "php-developer", "pl")
...
print("National Nestor's:",user4.nation)
print("Pay Nestor's:",user4.pay)
user4.percentage()
